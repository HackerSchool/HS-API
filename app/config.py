...
class Config:
    ...
    SESSION_FILE_DIR = _get_env_or_default("SESSION_DIR", os.path.join(os.getcwd(), 'flask_session'))  # Directory to store session files
    ...
    DATABASE_PATH = _get_env_or_default("DATABASE_PATH", 'hackerschool.db')
    TAGS_PATH = _get_env_or_default("TAGS_PATH", 'tags.json')
    LOGOS_PATH = _get_env_or_default("LOGOS_PATH", 'logos/')
